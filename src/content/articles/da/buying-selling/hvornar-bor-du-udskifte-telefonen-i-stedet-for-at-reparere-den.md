...
Reparation af opladningsporten hører til samme kategori. Prisen ligger ofte omkring 400-900 kr. hos danske værksteder, og arbejdet kan på mange modeller klares samme dag, og løsningen er normalt holdbar. Ustabil opladning fra en slidt eller tilstoppet port er en af de mest almindelige grunde til, at folk begynder at se efter en ny telefon, selv om det samtidig er blandt de billigere problemer at løse.
...
Nogle situationer gør reparation til et dårligt væddemål, selv når prisen umiddelbart ser rimelig ud.

**Flere problemer på én gang.** En telefon, der både behøver nyt batteri, har revnet skærm og oplader ustabilt, kan ende på 1.500-3.000 kr. eller mere i samlede reparationer. På det tidspunkt er en et år gammel istandsat telefon uden de problemer og med længere softwaresupport ofte det klogere køb.

**Softwaresupporten er slut.** En telefon, der ikke længere modtager sikkerhedsopdateringer, har kendte og offentligt dokumenterede sårbarheder. Til almindelige opkald og beskeder er det en risiko, nogle vil acceptere. Til bankapps, arbejdsmail eller betalinger er den sværere at forsvare. Nogle bank- og virksomhedsapps kan afvise at køre, når sikkerhedsrettelserne er for gamle, Android-versionen ikke længere understøttes, eller Play Integrity-kontrollen fejler. En hardwarereparation på en telefon med mindre end ét års opdateringer tilbage forlænger hardwarens levetid, men ikke softwarens.

**Vandskade.** En telefon, der virker efter kontakt med vand, kan se uskadt ud, mens korrosionen breder sig indvendigt over uger og måneder. En reparation af de første symptomer, for eksempel en ustabil skærm eller opladning, løser ikke nødvendigvis det, der sker på resten af printkortet. Medmindre telefonen blev professionelt tørret og renset umiddelbart efter skaden, udvikler vandskadede telefoner ofte nye fejl efter reparationen.
...
### Kan en nulstilling til fabriksindstillinger erstatte en reparation på en langsom telefon?

En nulstilling løser softwareproblemer som ophobede konflikter mellem apps, beskadigede cachefiler og for mange baggrundsprocesser. Hvis telefonen kører godt efter en ren nulstilling, uden at apps er gendannet fra en sikkerhedskopi, lå problemet i softwaren, og en reparation er ikke nødvendig. Er den stadig langsom på en frisk installation, ligger årsagen i hardwaren, for eksempel nedslidt lager, et svækket batteri eller for lidt RAM. Det kan en nulstilling ikke rette.

### Hvad med forsikring eller reklamationsret?

Kontrollér først, om problemet er dækket af reklamationsretten eller en frivillig garanti. I Danmark har du som udgangspunkt to års reklamationsret over for forhandleren, hvis der er en mangel ved varen. Den dækker ikke nødvendigvis almindeligt slid, et tab eller anden selvforskyldt skade, og en producentgaranti kan have andre vilkår. En indboforsikring eller særskilt elektronikforsikring kan dække uheld, men se på selvrisiko, aldersfradrag og eventuel dobbeltforsikring, før du anmelder skaden. Besparelsen kan være mindre, end den først ser ud til.

### Er det billigere at skifte batteriet selv?

Et batteri eller et gør det selv-sæt kan koste cirka 200-600 kr. til mange telefoner, sammenlignet med omkring 400-1.100 kr. på et værksted. Besparelsen er reel, men det er risikoen også. Telefoner med limet bagside kræver varme for at blødgøre limen, og værktøjet kan beskadige skærmen eller punktere batteriet. På telefoner, der er konstrueret til batteriskift, som Fairphone og visse robuste modeller, er arbejdet ligetil. På lukkede topmodeller betaler værkstedsprisen for erfaring og normalt også en form for ansvar for arbejdet.

---

Én defekt del på en ellers god telefon er en reparation. Tre defekte dele på en aldrende telefon med udløbende softwaresupport er en udskiftning. De fleste beslutninger falder tydeligt i den ene kategori, når reparationsprisen, den resterende opdateringsperiode og antallet af samtidige fejl ligger på bordet.
