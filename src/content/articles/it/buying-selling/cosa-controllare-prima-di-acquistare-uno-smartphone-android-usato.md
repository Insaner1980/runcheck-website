---
title: "Cosa controllare prima di acquistare uno smartphone Android usato"
description: "Uno smartphone di fascia alta dell'anno scorso si può spesso trovare a meno della metà del prezzo di lancio, se è in buone condizioni. Il risparmio è reale, ma lo è anche il rischio di pagare per un telefono bloccato da un operatore, inserito in una blacklist, ancora collegato all'account di un'altra persona o già vicino alla fine del supporto di sicurezza."
listSummary: "Uno smartphone di fascia alta dell'anno scorso si può spesso trovare a meno della metà del prezzo di lancio."
hub: "buying-selling"
sourceNumber: 6
order: 4
