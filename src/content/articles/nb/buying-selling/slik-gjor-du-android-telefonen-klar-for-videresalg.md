---
title: "Slik gjør du Android-telefonen klar for videresalg"
description: "Rekkefølgen betyr noe. Når kontoene fjernes før tilbakestilling, hindrer du at Factory Reset Protection låser kjøperen ute. Når sikkerhetskopien tas før kontoene fjernes, unngår du å miste data. Hopper du over et trinn eller gjør dem i feil rekkefølge, kan telefonen enten miste innhold eller bli umulig for kjøperen å konfigurere."
listSummary: "Rekkefølgen betyr noe."
hub: "buying-selling"
sourceNumber: 5
order: 3
...
Bilder og videoer krever egen kontroll. Hvis Google Photos eller en annen skytjeneste er aktiv, må du bekrefte at alt er synkronisert ved å se etter statusen `Backup complete` i appen. Innhold som bare finnes på enheten, må flyttes manuelt til en datamaskin, ekstern lagringsenhet eller skytjeneste.
...
Åpne kontodelen i Innstillinger, ofte kalt `Accounts` eller `Passwords & Accounts`, og fjern alle Google-kontoer som er oppført. Dette er det viktigste trinnet før salg. Hvis telefonen tilbakestilles uten at Google-kontoen er fjernet først, aktiveres Factory Reset Protection (FRP), og kjøperen kan ikke fullføre oppsettet uten den forrige eierens innloggingsopplysninger. Det finnes ingen legitim omgåelse.

Samsung-telefoner har en egen Samsung-konto. Fjern den fra kontodelen i Innstillinger. Xiaomi-telefoner har en Mi Account med en tilsvarende lås. Hvis slike kontoer blir stående, kan de skape samme type låsing som FRP.

Slå av Find Hub eller Find My Device, avhengig av Android-versjon og region.
...
Tørk av skjermen og baksiden med en mikrofiberklut. Bruk en tannpirker av tre til å fjerne lo fra ladeporten og høyttaleråpningene. Rengjør kameralinsen. Ta av deksel og skjermbeskytter, slik at kjøperen kan se den faktiske tilstanden.

Ta tydelige bilder av alle fire sider, skjermen slått på ved oppsettskjermen og alle kosmetiske skader. Fotografer IMEI-nummeret i SIM-kortskuffen eller slik det vises når du taster `*#06#`. Hvis du kontrollerte batterihelsen før tilbakestillingen, bør du også legge ved skjermbildet.
...
Private markedsplasser som FINN.no og Facebook Marketplace gir vanligvis mest penger, men krever mer arbeid: annonse, spørsmål, sending eller møte med kjøper. Bruk betalings- og fraktløsninger med kjøperbeskyttelse når det er mulig, og opplys tydelig om alle feil.

Innbytte hos operatører og forhandlere er enklere, men gir vanligvis mindre enn privat salg. Telenor Innbytte og Telia Mobilpant gir prisestimat og tar imot telefonen for kontroll. Elkjøp har også en innbytteordning. Kontroller gjeldende verdi og vilkår før du velger tjeneste.

Oppkjøps- og innbyttetjenester kan gi et raskt tilbud og ordne innsendingen. Det går fort, men utbetalingen gjenspeiler bekvemmeligheten.

---

Hele prosessen tar omtrent en time. Mesteparten av tiden går til sikkerhetskopiering og tilbakestilling. Minuttene du bruker på å fjerne kontoer og dokumentere tilstanden, er det som skiller et problemfritt salg fra en kjøper som ikke får satt opp telefonen.
