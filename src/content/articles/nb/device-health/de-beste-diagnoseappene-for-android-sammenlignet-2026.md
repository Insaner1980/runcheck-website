...
draft: false
---
De fleste diagnoseapper for Android er egentlig ikke diagnoseapper. De er batteriwidgeter, spesifikasjonslister, annonsefeller eller gamle "telefonrenser-apper" som har fått en tilstandsscore på toppen.

De bedre appene er mer ærlige om hva de gjør. AccuBattery følger batteriets oppførsel over tid. DevCheck og AIDA64 viser maskinvaredetaljer. Phone Doctor Plus lar deg kjøre praktiske komponenttester. runcheck vurderer enhetens tilstand på tvers av batteri, temperatur, nettverk og lagring, i stedet for å behandle ett tall som hele sannheten.
...
Det siste er viktig. Du installerer ikke AccuBattery, lader i ti minutter og får plutselig vite den virkelige batterihelsen. Appen trenger flere ladeøkter fordi den bygger en modell av det telefonen rapporterer under lading. Strømmålingene kommer fra Androids batteri-API-er og enhetens batterimåler. Noen telefoner gir ryddige data. Andre avrunder verdiene. Enkelte rapporterer tall som svinger så mye at anslaget blir ujevnt.

AccuBattery følger også ladehastighet, utladingshastighet, forbruk med skjermen på og av, dyp hvile og beregnet slitasje per ladeøkt. Ladealarmen ved 80 % er fortsatt en av de mest praktiske funksjonene. Den beskytter ikke batteriet på magisk vis, men minner deg på å unngå at telefonen blir liggende fulladet og varm i timevis.

Premium låses opp med et engangskjøp i appen. Det fjerner annonser og åpner eldre historikk. Jeg ville ikke kjøpt det på dag én. Bruk gratisversjonen i en uke, se om tallene stabiliserer seg, og bestem deg deretter. Den lokale prisen vises i Google Play og kan variere.
...
Den støtter også root og Shizuku for å hente mer systeminformasjon på kompatible enheter. Dermed får avanserte brukere bedre innsyn uten at appen blir et verktøy som bare fungerer på rootede telefoner.

Gratisversjonen er nyttig alene. Pro er et engangskjøp og legger til tester, ytelsesmålinger, widgeter, flytende overvåkingsvinduer og batteriovervåking. Prisen varierer etter region, så gamle skjermbilder er en dårlig kilde når du skal sjekke kostnaden.
...
Jeg liker AIDA64 til rask kontroll. Hvis en selger hevder at en telefon har Snapdragon 8 Gen 3 og 12 GB RAM, kan AIDA64 hjelpe deg med å bekrefte det før du går videre. Som daglig tilstandsovervåker er appen mindre nyttig, fordi den hovedsakelig viser det Android gjør tilgjengelig. Den har ikke noe egentlig lag som sier: "Dette er problemet."
...
Haken er Androids tilgangsmodell. Nyere Android-versjoner og nyere enheter blokkerer mer maskinvareinformasjon på lavt nivå enn eldre modeller. Appens egen beskrivelse sier at enkelte avlesninger er sperret på nyere enheter, og at root kan gi tilgang til mer. Dermed kan appen være imponerende på én telefon og merkelig ufullstendig på en annen.
...
Denne appkategorien er viktigere enn mange tror når du undersøker en brukt telefon.
...
## Hvilken app svarer på hvilket spørsmål?

Ved tap av batterikapasitet bør du begynne med AccuBattery, men gi appen tid. På Pixel 8a og nyere bør du også sjekke `Innstillinger > Batteri > Batteritilstand` og `Innstillinger > Om telefonen > Batteriinformasjon`. De innebygde Pixel-sidene kan være mer nyttige enn et tredjepartsanslag når enheten støtter dem.

Bruk DevCheck eller AIDA64 for nøyaktig maskinvareidentitet. DevCheck er enklere å bruke til daglig. AIDA64 er en god og tettpakket referanse.
...
### Er diagnoseapper trygge?

Etablerte apper fra Google Play er vanligvis trygge når tillatelsene samsvarer med det appen faktisk gjør. En batteriapp trenger ikke kontaktene dine. En app som tester maskinvaren, kan trenge tilgang til kamera og mikrofon fordi den skal teste disse delene. Den forskjellen er viktig.

### Tømmer diagnoseapper batteriet?

En passiv spesifikasjonsapp påvirker batteriet lite dersom du bare åpner den av og til. Alt som overvåker i bakgrunnen, bruker noe strøm. Aktiver bakgrunnsmåling bare når du faktisk trenger historikken.

### Kan appene oppdage falske eller utskiftede deler?

De kan hjelpe, men de er ikke magiske. AIDA64 og DevCheck kan avsløre tydelige avvik i spesifikasjonene, og Device Info HW kan noen ganger gå dypere i komponentidentiteten. Utskiftede skjermer og batterier er vanskeligere. Samsung Members kan varsle om enkelte batteriproblemer, men profesjonelle aktører som klargjør brukte telefoner bruker fortsatt verktøy som vanlige apper ikke har tilgang til.

### Hvorfor viser appene ulike tall for batterihelse?

Fordi de ikke måler det samme. AccuBattery anslår kapasitet ut fra ladeatferd. Pixel-funksjonen for batteritilstand bruker data fra telefonens egen batterimåler på modeller som støtter det. Strømmålingene i Android varierer også mellom enheter. En forskjell på 5 % mellom verktøyene er ikke oppsiktsvekkende.
